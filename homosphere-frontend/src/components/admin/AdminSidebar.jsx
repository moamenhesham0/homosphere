    ...
    <aside className="fixed inset-y-0 left-0 h-screen w-64 border-r border-gray-100 bg-[#faf9fe] flex flex-col py-6 px-4 z-50">
      ...
      <nav className="flex-1 space-y-2">
        <Link 
          ...
          className={`flex items-center gap-3 px-4 py-3 transition-all ${path === '/admin/review-request' ? 'text-[#476738] font-bold border-r-4 border-[#476738] bg-[#f4f3f8]' : 'text-gray-500 hover:text-[#476738] hover:bg-[#f4f3f8] font-medium'}`}
        >
        ...
        <a className="flex items-center gap-3 px-4 py-3 text-gray-500 hover:text-[#476738] hover:bg-[#f4f3f8] transition-colors font-medium" href="#">
