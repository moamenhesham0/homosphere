export default function Footer() {
  return (
    <footer className="bg-stone-100 dark:bg-stone-950 w-full border-t border-stone-200/15 mt-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto px-8 py-16">
        <div className="space-y-6">
          <div className="text-xl font-bold text-emerald-900 dark:text-emerald-50 font-headline">Horizon Realty</div>
        ...
        <div>
          <h5 className="text-emerald-900 dark:text-emerald-100 font-semibold mb-6 font-headline">Company</h5>
          <ul className="space-y-4 text-stone-500 dark:text-stone-400 font-body text-sm">
        ...
        <div>
          <h5 className="text-emerald-900 dark:text-emerald-100 font-semibold mb-6 font-headline">Explore</h5>
          <ul className="space-y-4 text-stone-500 dark:text-stone-400 font-body text-sm">
        ...
        <div>
          <h5 className="text-emerald-900 dark:text-emerald-100 font-semibold mb-6 font-headline">Legal</h5>
          <ul className="space-y-4 text-stone-500 dark:text-stone-400 font-body text-sm">
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 border-t border-stone-200/10 flex flex-col md:flex-row justify-between items-center gap-4">
        <span className="text-stone-500 dark:text-stone-400 font-body text-sm">© 2024 Horizon Realty. All rights reserved.</span>
        <div className="flex gap-8">
          <a className="text-stone-500 dark:text-stone-400 text-xs hover:text-emerald-700 font-body" href="#">Privacy Policy</a>
          <a className="text-stone-500 dark:text-stone-400 text-xs hover:text-emerald-700 font-body" href="#">Terms of Use</a>
          <a className="text-stone-500 dark:text-stone-400 text-xs hover:text-emerald-700 font-body" href="#">Accessibility</a>
        </div>
      </div>
    </footer>
  );
