...
const customIcon = new L.Icon({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="45" viewBox="0 0 32 45">
      <path fill="#476738" stroke="#fff" stroke-width="2" d="M16 0C7.2 0 0 7.2 0 16c0 11 16 29 16 29s16-18 16-29c0-8.8-7.2-16-16-16z"/>
...
function LocationMarker({ position, setPosition, onLocationSelect, onLocationLoadingChange }) {
    ...
    useMapEvents({
        click(e) {
            ...
            const timeout = setTimeout(async () => {
                ...
                try {
                    await fetchLocationData(e.latlng.lat, e.latlng.lng, onLocationSelect);
                } finally {
 ...
 * @param {Function} onLocationLoadingChange - Callback that receives loading state while geocoding/reverse-geocoding
...
const GeoMap = ({
    ...
    }, [clearMarker, onLocationLoadingChange, onLocationSelect]);
            ...
            <div style={{ height: '100%', width: '100%' }}>
                ...
                >
                    ...
                    <LocationMarker
                        ...
                        onLocationLoadingChange={onLocationLoadingChange}
                    />
                </MapContainer>
            </div>
        </div>
