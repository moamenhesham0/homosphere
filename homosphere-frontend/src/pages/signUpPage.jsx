...
import { textToEnum } from '@utils/enumConverter.js';
...
const SignUp = () => {
    ...
    const setErrorMessage = (message) => {
        setError(message);
        setTimeout(() => setError(''), DELAYS.SIGNUP_ERROR_DELAY);
    };
    ...
    const sendDataToSupabaseSuccess = (result) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (result.success) {
                sendDataToSupabaseSuccess(result);
            } else {
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <label className="checkbox-label">
                    <input
                        ...
                        className="checkbox"
                        style={{
                            borderColor: !agreedToTerms ? COLORS.DARK_RED : COLORS.JUNGLE_GREEN,
                        }}
                    />
                    <span>
                        I agree to the{' '}
